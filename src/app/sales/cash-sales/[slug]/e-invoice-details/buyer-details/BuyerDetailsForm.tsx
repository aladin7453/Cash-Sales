                        ...
                        <TooltipProvider delayDuration={1000}>
                          <Tooltip>
                            <TooltipTrigger asChild>
                              <Input
                                className="h-7.5 rounded-md bg-erp-gray-1 border-gray-200 px-2 text-[11px] text-black focus-visible:ring-0 focus-visible:outline-none"
                                {...field}
                                placeholder="TTx No"
                                readOnly
                              />
