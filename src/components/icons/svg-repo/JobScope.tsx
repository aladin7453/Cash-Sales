export default function JobScope(props: React.SVGProps<SVGSVGElement>) {
    return (
      <svg
        width="40"
        height="40"
	...
	C35.3,31,36.2,31.9,37.3,31.9z" transform="scale(2.8)"/>
	...
	V31C76,27.6,73.3,24.9,70,24.9z" transform="scale(2.8)"/>
	...
	C79.5,79.5,79,80,78.4,80z" transform="scale(2.8)"/>
      </svg>
    );
  }
