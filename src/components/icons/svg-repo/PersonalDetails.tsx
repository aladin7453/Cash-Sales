export default function DriverDetails(props: React.SVGProps<SVGSVGElement>) {
    return (
      <svg
        width="40"
        height="40"
...
<g id="XMLID_91_">
	<path id="XMLID_92_" d="M355.606,334.381l-63.854-63.855C315.619,241.903,330,205.107,330,165.013c0-90.981-74.019-165-165-165
		...
		s-20.148,45.001-45,45.001c38.658,0,69.999,31.337,69.999,70H95z" transform="scale(0.7)"/>
</g>
  </svg>
    );
  }
