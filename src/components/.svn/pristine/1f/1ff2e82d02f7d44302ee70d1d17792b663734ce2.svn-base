...
const PreviewPDF = ({
  ...
  template2Mode = false,
  QrCode,
  showService2SummaryRemark1,
  showService4SummaryRemark1TIN,
}) => {
  if (!previewData) {
    return (
            ...
            <>
              ...
              >
                ...
                <View style={styles2.leftColumn}>
                  {showService4SummaryRemark1TIN === true ? (
                    <>
                      <View style={styles.section}>
                        <Text style={[styles.boldText, { fontSize: 10, marginBottom: 2 }]}>
                        ...
                        >
                          {cleanMainAddress || previewDoc.customerAddress || ""}
                        </Text>
                        <View style={styles.tableRowS4}>
                          <Text style={styles.tableCellLabel}>Tax Identification No:</Text>
                          <Text style={styles.tableCellValue}>{previewDoc.TIN || ""}</Text>
                        </View>
                        <View style={styles.tableRowS4}>
                          <Text style={styles.tableCellLabel}>Business Reg No. (New):</Text>
                          <Text style={styles.tableCellValue}>{previewDoc.BRN || ""}</Text>
                        </View>
                        <View style={styles.tableRowS4}>
                          <Text style={styles.tableCellLabel}>Business Reg No. (Old):</Text>
                          <Text style={styles.tableCellValue}>
                            {previewDoc.customerBRNOld || ""}
                          </Text>
                        </View>
                        <View style={styles.tableRowS4}>
                          <Text style={styles.tableCellLabel}>SST Reg No.:</Text>
                          <Text style={styles.tableCellValue}>{previewDoc.SSTNo || ""}</Text>
                        </View>
                        <View style={styles.tableRowS4}>
                          <Text style={styles.tableCellLabel}>MSIC Code:</Text>
                          <Text style={styles.tableCellValue}>
                            {previewDoc.supplierMSICCodeCode || ""}
                          </Text>
                        </View>
                        <View style={styles.tableRowS4}>
                          <Text style={styles.tableCellLabel}>Email Address:</Text>
                          <Text style={styles.tableCellValue}>{previewDoc.email || ""}</Text>
                        </View>
                        <View style={styles.tableRowS4}>
                          <Text style={styles.tableCellLabel}>Contact Number:</Text>
                          <Text style={styles.tableCellValue}>{previewDoc.phoneNo || ""}</Text>
                        </View>
                        <View style={styles.tableRowS4}>
                          <Text style={styles.tableCellLabel}>Contact Person Name:</Text>
                          <Text style={styles.tableCellValue}>
                            {previewDoc.attentionName || ""}
                          </Text>
                        </View>
                      </View>
                    </>
                ...
                >
                  {isNotMoreThanFiveLines && !showService4SummaryRemark1TIN ? (
                    <>
                      <View style={[styles.verticalLine2, { right: "50%", height: 70 }]} fixed />
                    </>
                  ) : null}
                  {/* after Date */}
                  <View
                    ...
                    <View
                      style={[
                        ...
                        styles.boldText,
                        {
                          ...
                          borderLeftWidth: 0,
                          borderRightWidth:
                            isNotMoreThanFiveLines && !showService4SummaryRemark1TIN ? 0 : 1,
                        },
                      ]}
                    >
                  ...
                  <View
                    style={[
                      styles2.row,
                      {
                        ...
                        borderLeftWidth: 0,
                        borderBottomWidth:
                          showService4SummaryRemark1TIN === true || !isNotMoreThanFiveLines ? 1 : 0,
                      },
                    ]}
                  >
                    <View
              ...
              <View style={styles.contentContainer}>
                ...
                <View style={[styles.table]}>
                  ...
                  <View style={[styles.tableRowHeader, styles.tableHeader]} fixed>
                    ...
                    <View style={[styles.tableCellHeader, { flex: 2.7 }]}>
                      <Text>Name</Text>
                    </View>
                    <View style={[styles.tableCellHeader, { flex: 1 }]}>
                      <Text>Chit No.</Text>
                    ...
                    <>
                      <View style={styles.tableRow} key={index}>
                        ...
                        <View style={[styles.tableCell, { flex: 1, textAlign: "center" }]}>
                          <Text>
                            {showService2SummaryRemark1 === true ||
                            showService4SummaryRemark1TIN === true
                              ? item.dateFormat
                              : item.description}
                          </Text>
                        ...
                        <View
                          style={[
                            styles.tableCell,
                            { flex: 2.7, textAlign: "left", paddingLeft: 4 },
                          ]}
                        >
                          <Text>
                            {showService2SummaryRemark1 === true ||
              ...
              <View style={[styles.verticalLine2Payment, { left: "100%" }]} fixed /> */}
                  ...
                  <View style={[styles.tableCellHeaderPayment, { flex: 4, textAlign: "right" }]}>
                    <Text
                      render={({ subPageNumber, subPageTotalPages }) =>
