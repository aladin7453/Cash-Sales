...
const SVGSealFrame: React.FC<SVGSealFrameProps> = ({
  width = 24,
  height = 24,
  color = "currentColor",
  className = "",
  ...
  return (
    ...
    >
      <g>
        <path
          fill={color}
          d="M412.175,352.363c-12.529,3.75-24.842,10.263-37.217,22.584l-0.015,0.015
        ...
        <path
          fill={color}
          d="M256.008,0.003C114.618,0.003,0.007,114.608,0,255.989c0.007,141.396,114.618,256.008,256.008,256.008
