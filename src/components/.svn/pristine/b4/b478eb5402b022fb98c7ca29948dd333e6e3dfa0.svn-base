...
import type { TransferToPopoverToolbarProps } from "./types";

export default function TransferToPopoverToolbar({
  table,
  setOpen,
  setOpenDialog,
  fetchItems,
    ...
    <>
      <div className="flex items-center justify-between p-1.5">
        ...
        <div className="grid grid-cols-2 items-center text-erp-blue-14">
          <Refresh refreshTable={fetchItems} />
