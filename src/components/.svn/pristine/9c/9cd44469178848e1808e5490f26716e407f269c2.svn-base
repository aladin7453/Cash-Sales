              ...
              <View style={styles.contentContainer}>
                ...
                <View style={[styles.table]}>
                  ...
                  <View style={[styles.tableRowHeader, styles.tableHeader]} fixed>
                    ...
                    <View style={[styles.tableCellHeader, { flex: 0.9 }]}>
                      <Text>Date</Text>
                    </View>
                    <View style={[styles.tableCellHeader, { flex: 2.1 }]}>
                      <Text>Name</Text>
                    </View>
                    <View style={[styles.tableCellHeader, { flex: 0.6 }]}>
                      <Text>Price</Text>
                    </View>
                    <View style={[styles.tableCellHeader, { flex: 0.6 }]}>
                      <Text>Tax</Text>
                  ...
                  {itemArray.map((item, index) => (
                    <>
                      <View style={styles.tableRow} key={index}>
                        ...
                        <View style={[styles.tableCell, { flex: 0.9, textAlign: "center" }]}>
                        ...
                        <View style={[styles.tableCell, { flex: 0.6, textAlign: "right" }]}>
                          <Text>{formatDecimal(item.price)}</Text>
                        </View>
                        <View style={[styles.tableCell, { flex: 0.6, textAlign: "center" }]}>
                          <Text>{stripHtml(item["taxCode"] || "")}</Text>
                        </View>
                        <View style={[styles.tableCell, { flex: 0.6, textAlign: "right" }]}>
                          <Text>{formatDecimal(item.taxRate)}</Text>
                        </View>
                        <View style={[styles.tableCell, { flex: 0.9, textAlign: "right" }]}>
