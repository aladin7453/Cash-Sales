        ...
        <View style={styles.contentContainer}>
          ...
          <View style={styles.mainContainer}>
            ...
            <View style={styles.leftColumn}>
              <View style={styles.section}>
                <Text style={styles.boldText}>{previewData.supplierName || ""}</Text>
                <Text>{previewData.address || ""}</Text>
              </View>
              <View style={styles.section}>
                <Text>Attention: {previewData.attentionName || ""}</Text>
                <Text style={styles.sectionText}>Phone No.: {previewData.phoneNo || ""}</Text>
                <Text style={styles.sectionText}>Email: {previewData.email || ""}</Text>
              </View>
            </View>
            ...
            <View style={styles.rightColumn}>
              <View style={styles.section}>
                <Text>No.: {previewData.docNo || ""}</Text>
                <Text>Date: {previewData.docDateFormat || ""}</Text>
                <Text>Agent: {previewData.agentName || ""}</Text>
                <Text>Terms: {previewData.creditTermCode || ""}</Text>
              </View>
            </View>
          </View>
          ...
          {previewData.description && (
            <View style={styles.description}>
              <Text>DESC: {stripHtml(previewData.description)}</Text>
            </View>
          )}
          ...
          <View style={styles.table}>
            ...
            {previewData.unappliedAmount && Number(previewData.unappliedAmount) > 0 && (
              <View style={[styles.tableRow, styles.lastRow]}>
                ...
                <View style={[styles.tableCell, { flex: 3 }]}>
                  <Text>{Number(previewData.unappliedAmount || 0).toFixed(2)}</Text>
                </View>
              </View>
            )}
          </View>
            ...
            <View style={styles.botContainer}>
              ...
              <View style={[styles.leftBotColumn, {fontSize: 10}]}>
                <View style={styles.currency}>
                  ...
                  <Text>{previewData.currencyName}: {convertNumberToWords(previewData.paidAmount)}</Text>
                </View>
              </View>
              ...
              <View style={[styles.qtyTable, styles.rightBotColumn]}>
                <View style={[styles.tableRow]}>
                  ...
                  <View style={[styles.qtyTableCellNumber, styles.noBorderLeft, { flex: 2 }]}>
                    <Text>{previewData.paidAmount || "0"}</Text>
                  </View>
                </View>
