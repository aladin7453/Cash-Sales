/**
 * This is a custom component for the date and time picker,
 * using the `Calendar` component as a base, not from Shadcn UI itself.
 */
...
function DateTimePicker({
  ...
  const now = new Date();
  const minDate = allowPastRecord ? undefined : now;
  ...
  return (
    <>
      <DayPicker
        ...
        // Disable all days before today when past record is not allowed
        ...
        <div className="font-medium">
          <div className="flex items-center gap-2">
            <TimePickerInput
              ...
              // Disable manual typing of past hours when on today's date and past record not allowed
              min={
                !allowPastRecord && selectedDate &&
            ...
            <TimePickerInput
              ...
              // Disable manual typing of past minutes when on today's date+hour and past record not allowed
              min={
                !allowPastRecord && selectedDate &&
                selectedDate.toDateString() === now.toDateString() &&
