          ...
          <Page size="A4" key={index} style={[styles.page, { paddingBottom: 160 }]}>
            <>
              ...
              >
                ...
                <View style={[styles2.rightColumn, { height: 70, alignSelf: "flex-start" }]}>
                  ...
                  <View style={[styles.tableRowHeader, styles.tableHeader]} fixed>
                    ...
                    <View
                      style={[
                        styles.verticalLine2,
                        {
                          left: showService2Summary === true ? "30%" : "22.24%",
                          height: isNotMoreThanFiveLines
                            ? 435.9
                            : visualLineCount === 4
                              ? 420
                    ...
                    <View
                      style={[
                        styles.verticalLine2,
                        {
                          left: showService2Summary === true ? "78%" : "83.14%",
                          height: isNotMoreThanFiveLines
                            ? 435.9
                            : visualLineCount === 4
                              ? 420
                    ...
                    <>
                      <View style={styles.tableRow} key={index}>
                        ...
                        <View style={[styles.tableCell, { flex: 1, textAlign: "center" }]}>
                          <Text>
                            {showService2SummaryBRN === true || showService2Summary === true
                              ? item.dateFormat
                              : item.description}
                          </Text>
                        </View>
                        <View
                          style={[
                            styles.tableCell,
                            {
                              flex: 2.7,
                              textAlign: "left",
                              paddingLeft: showService2Summary === true ? 30 : 4,
                            },
                          ]}
                        >
                          <Text>
                        ...
                        {showService2Summary === true ? null : (
                          <View style={[styles.tableCell, { flex: 1, textAlign: "center" }]}>
                            <Text>
                              {showService2SummaryBRN === true
                                ? insertLineBreak(item.customerBRN)
                                : insertLineBreak(item.remark1)}
                            </Text>
                          </View>
                        )}
                        <View
