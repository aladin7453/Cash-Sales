...
const PreviewDOItemizedTemplate2 = ({
  previewData,
  itemsData,
  currentCompanyData,
  currentUser,
            ...
            <View style={styles.contentContainer}>
              ...
              <View style={styles.table}>
                <View style={[styles.tableRow, styles.tableHeader]}>
                  ...
                  <View style={[styles.tableCell, { flex: 5 }, styles.tableCellLeftAlign]}>
                    <Text>Item Name</Text>
                  </View>
                  <View style={[styles.tableCell, { flex: 1 }]}>
                    <Text>UOM</Text>
                  ...
                  <>
                    <View style={[styles.tableRow, styles.lastRow]} key={index}>
                      ...
                      <View style={[styles.tableCell, { flex: 1 }]}>
                        ...
                        <View style={[styles.tableCell, { flex: 1 }]}>
                        {item.balance ? <Text>{item.balance}</Text> : null}
                      </View>
                        <View style={[styles.tableCell, { flex: 1 }]}>
                        {item.finalBalance  ? <Text>{item.finalBalance}</Text> : null}
                      </View>
                      {PDFPreviewType !== "SALES DELIVERY ORDER" && (
                        <>
                          <View style={[styles.tableCell, { flex: 1 }]}>
...
export default PreviewDOItemizedTemplate2;
