...
const styles = StyleSheet.create({
  ...
  totalRow: {
    ...
    width: 130, // adjust width to control spacing
  },
  paragraphSection: {
    marginTop: 5,
    fontSize: 8,
  ...
  signature: {
    marginTop: 15,
    marginLeft: 30, // adjust indentation like in image
  },
  signatureLine: {
    // marginLeft: 35,
    marginTop: 1,
  ...
  headerDateContainer: {
    flexDirection: "row",
    justifyContent: "flex-end", // keeps the whole block on the right
    width: "100%",
  },
  headerDateText: {
    fontSize: 7,
    textAlign: "left", // text inside aligns left
    alignItems: "flex-start", // ensures both lines align left
    width: 80, // adjust width to fit your content nicely
  },
});

const CustomerOverdueLetterTemplate = ({
  data,
  salesReportData,
  generatedReport,
  salesReportColumns,
  ...
  const renderHeader = () => (
    <>
      ...
      <View style={styles.headerDateContainer}>
        <View style={styles.headerDateText}>
          ...
          rows.map((customer, customerIndex) => (
            <View style={styles.contentContainer} key={customer.UUID || customerIndex} break={customerIndex !== 0}>
                    ...
                    {salesReportColumns
                      ...
                      >
                        {column.header === "No"
                          ...
                          ? formatDecimal(doc[column.accessorKey])
              ...
              <View style={styles.bottomSection} wrap={false}>
                ...
                <View style={styles.totalAmtSection}>
                  <View style={styles.totalRow}>
                    <Text>Total Amount:</Text>
                    <Text>{formatDecimal(customer.totalAmount)}</Text>
                  </View>
                </View>

                <View style={styles.paragraphSection}>
                  <Text>We shall be grateful if you could let us have your payment soonest possible.</Text>
                  <Text style={styles.paragraph}>
                    This is a computer generated document. Please ignore this reminder should you have made the aforesaid payment.
                  </Text>
                  <Text style={styles.paragraph}>Thank you and best regards,</Text>
                  <Text style={styles.paragraph}>Yours faithfully,</Text>

                  <Text style={styles.signature}>Account Dept.</Text>
...
export default CustomerOverdueLetterTemplate;