...
const styles = StyleSheet.create({
  ...
  logoContainer: {
    ...
    top: 30,
    right: 30,
    width: 100,         // ✅ removed duplicate width: "20%"
    height: 100,
    marginBottom: 10,
    overflow: "hidden",
    padding: 0,
        ...
        return (
          <Page key={index} size="A4" style={styles.page}>
            ...
            <View style={styles.contentContainer}>
              ...
              <View style={styles.section}>
                <Text>
                  <Text style={styles.boldText}>Dear</Text> {previewDoc.attentionName}
                </Text>
              ...
              <View style={styles.table}>
                ...
                {/* ✅ Fragment replaced with React.Fragment with key prop */}
                      ...
                      {showMultipleUOM ? (
                        <>
                          <View style={[styles.tableCell, { flex: 2 }]}>
                            ...
                            <View style={[styles.tableCellUnderline, (!item.quantity || !item.itemUOM) && { marginTop: 10 }]} />
                          </View>
                          <View style={[styles.tableCell, { flex: 2 }]}>
                            <Text>{(item.quantity2 && item.itemUOM2) ? `${item.quantity2 || ""} ${item.itemUOM2 || ""}` : ""}</Text>
                            <View style={[styles.tableCellUnderline, (!item.quantity2 && !item.itemUOM2) && { marginTop: 10 }]} />
                          </View>
                          <View style={[styles.tableCell, { flex: 2 }]}>
                            <Text>{(item.quantity3 && item.itemUOM3) ? `${item.quantity3 || ""} ${item.itemUOM3 || ""}` : ""}</Text>
                            <View style={[styles.tableCellUnderline, (!item.quantity3 && !item.itemUOM3) && { marginTop: 10 }]} />
                          </View>
                        </>
                      ) : (
                        <>
